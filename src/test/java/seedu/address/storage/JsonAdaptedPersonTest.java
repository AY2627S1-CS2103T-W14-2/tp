...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nonEmptyRemark_preservesRemark() throws Exception {
        Person person = new PersonBuilder(BENSON).withRemark("Likes swimming").build();
    ...
    public void toModelType_nullRemark_throwsIllegalValueException() {
        ...
        String message = String.format(MISSING_FIELD_MESSAGE_FORMAT, Remark.class.getSimpleName());
